//
//  NKWActivityIndicatorBallZigZagDeflectAnimation.m
...
@implementation NKWActivityIndicatorBallZigZagDeflectAnimation
...
- (void)setupAnimationInController:(WKInterfaceController*)controller Images:(NSArray*)images withSize:(CGSize)size tintColor:(UIColor *)tintColor duration:(CGFloat)duration
{
    ...
    [controller animateWithDuration:duration/6.0 animations:^{
    ...
    dispatch_time_t firstDelay = dispatch_time(DISPATCH_TIME_NOW, duration/6.0 *NSEC_PER_SEC);
    ...
    dispatch_time_t secondDelay = dispatch_time(DISPATCH_TIME_NOW, duration*2/6.0 *NSEC_PER_SEC);
    ...
    dispatch_time_t thirdDelay = dispatch_time(DISPATCH_TIME_NOW, duration*3/6.0 *NSEC_PER_SEC);
    dispatch_after(thirdDelay, dispatch_get_main_queue(), ^{
    ...
    dispatch_time_t fouthDelay = dispatch_time(DISPATCH_TIME_NOW, duration*4/6.0 *NSEC_PER_SEC);
    dispatch_after(fouthDelay, dispatch_get_main_queue(), ^{
    ...
    dispatch_time_t fifthDelay = dispatch_time(DISPATCH_TIME_NOW, duration*5/6.0 *NSEC_PER_SEC);
    dispatch_after(fifthDelay, dispatch_get_main_queue(), ^{
