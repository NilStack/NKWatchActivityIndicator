//
//  NKWActivityIndicatorBallScaleAnimation.m
...
@implementation NKWActivityIndicatorBallScaleAnimation
...
{
    NSAssert([images count] == 1, @"Ball scale animation needs one image.");
